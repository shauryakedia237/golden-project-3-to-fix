...
function draw(){
   ...
   if (ghost1.y <= 760 && ghost1.x === 160 ){
    ...
    else if ( ghost2.y === 263 && ghost2.x <= 730 ) {
        ghost2.x += 7;
    ...
    else if (ghost2.y >= 360 && ghost2.y <= 460 && ghost2.x <= 360 ){
        ghost2.y += 7;
    } 
